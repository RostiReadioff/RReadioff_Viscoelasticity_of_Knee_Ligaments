function [] = formatedboxplot_Stress(x)
%UNTITLED6 Summary of this function goes here
%   Detailed explanation goes here
set(gca,'FontName','Times New Roman','FontSize',12,'LineWidth',0.5)
M={'1', '3', '5','1', '3', '5'}; %, 'M4','M5', 'M6','M7','M8','M9','M10', 'M11','M12'};
...
ax2 = axes('Position',ax1.Position,...
  'FontName','Times New Roman','FontSize',12,'LineWidth',0.5,...
...
legend(a([14 15]),{'1 %/min Ascending', '1 %/min Descending'},'Location','northwest','color','w','FontName','Times New Roman','FontSize',14);
end
