function [] = formatedboxplot_hysteresis(x)
...
plot([1 2 3],[7e-3 7e-3 7e-3],'b','LineWidth',1.5); plot ([2],[7.2e-3],'*b','LineWidth',1)
plot([1 2 3 4 5],[7.7e-3 7.7e-3 7.7e-3 7.7e-3 7.7e-3],'b','LineWidth',1.5); plot ([3],[7.9e-3],'*b','LineWidth',1)
